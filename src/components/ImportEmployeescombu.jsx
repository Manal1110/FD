...
const ImportEmployeeshc = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await axios.post('https://yazaki-api.onrender.com/employeescombu/import', formData, {
        headers: {
  ...
  const fetchStatistics = async (selectedMonth = enteredMonth) => {
    ...
    try {
      const employeesResponse = await axios.get(`https://yazaki-api.onrender.com/employeescombu/month/${monthToFetch}`);
      ...
      const statisticsResponse = await axios.get('https://yazaki-api.onrender.com/statisticscombu');
  ...
  const handleAddStat = async (event) => {
    event.preventDefault();
    try {
      await axios.post('https://yazaki-api.onrender.com/statisticscombu', newStat);
  ...
  const handleUpdateStat = async (event) => {
    ...
    try {
      if (!editStat) return;
      await axios.put(`https://yazaki-api.onrender.com/statisticscombu/${editStat._id}`, editStat);
  ...
  const handleDeleteStat = async (id) => {
    try {
      await axios.delete(`https://yazaki-api.onrender.com/statisticscombu/${id}`);
  ...
  const handleDelete = async (e) => {
    ...
    try {
      const response = await axios.delete(`https://yazaki-api.onrender.com/employeescombu/month/${deleteMonth}`);
